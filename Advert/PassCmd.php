	...
	<section class="module">
		<div class="module-inner">
			<div class="module-heading">
				<h3 class="module-title">Send Command</h3>
			...
			<div class="module-content collapse in" id="content-12">
				<div class="module-content-inner">
					<div class="form-horizontal">
						<div id="target">
							<form action="Advert/PassCmdSubmit.php" method="post"
								...
								<div class="form-group">
									<label class="col-sm-3 control-label">Select Cmd:</label>
									<div class="col-sm-9">
										<select class="chosen form-control"
											data-placeholder="Choose a Inventry Type"
											...
											<option value="scpt" disabled>Script</option>
										</select>
									</div>
								</div>
