...
if (rights_data ( $rights, 'Buglist' )) {
    ...
    `project_title`,
    `bug_raise_time`
FROM `bug_view` where bug_project = :bug_project;";
		$condition = [ 
    ...
    `project_title`,
    `bug_raise_time`
FROM `bug_view` where bug_raise_user_id = :bug_raise_user_id";
		// echo $query;
		$condition = [ 
...
// print_r($project_result);
                                                foreach ($project_result as $bug) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="name" ><a href="#" id="project_<?php echo $bug ['S_NO'];?>"><?php echo $bug['bug_titles']; ?></a></td>
                                                        ...
                                                        <td class="commit"><span
                                                                    class="count"><?php echo  date( 'd-m-Y H:i:s',strtotime($bug ['bug_raise_time'])); ?></span></td>
                                                        <td class="name">
                                                            <?php echo $comments; ?>
                                                            <span class=""><i class="fa fa-comment"></i><?php echo $add_comment; ?></span>
                                                            <div class="modal"
                                                        ...
                                                        <td class="updated">
                                                            <?php
                                                            $arr_rights = array('1' => 'Fixed by ODM Bugs', '2' => 'Resolve Bugs', '3' => 'Running change bugs', '4' => 'Close Bugs');
                                                            ...
                                                            <select
                                                                ...
                                                                ?>>Open</option>
                                                                <?php if (rights_data($rights, 'Buglist', 'Fixed by ODM Bugs')) { ?><option value="2"
                                                                    <?php
                                                                    if ($bug ['bug_status'] == 2) {
                                                                        echo 'selected';
                                                                    }
                                                                    ...
                                                                    ?>>Running Change</option><?php }if (rights_data($rights, 'Buglist', 'Close Bugs')) { ?>
                                                                    <option value="5"
                                                                    <?php
                                                                    if ($bug ['bug_status'] == 5) {
                                                                        echo 'selected';
