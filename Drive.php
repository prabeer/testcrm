						...
						<div class="side-bar">
							...
							<nav class="side-menu">
								<ul class="nav">
									...
									<li><a href="user-messages.html"><span
											class="pe-icon pe-7s-chat icon"></span> Messages</a></li>

									<li class="active"><a href="user-drive.html"><span
							...
							<div class="content-utilities">
								<div class="page-nav">
									...
									<div class="btn-group" role="group">
										<button class="active btn btn-default" data-toggle="tooltip"
											data-placement="bottom" title=""
											data-original-title="Grid View" id="drive-grid-toggle">
											<i class="fa fa-th-large"></i>
										</button>
										<button class="btn btn-default" data-toggle="tooltip"
											data-placement="bottom" title=""
											data-original-title="List View" id="drive-list-toggle">
							...
							<div class="drive-wrapper drive-grid-view">
								<div class="grid-items-wrapper">
									...
									<div class="drive-item module text-center">
										<div class="drive-item-inner module-inner">
											<div class="drive-item-title">
												<a href="#">Stock Image DC3214.JPG</a>
											</div>
											<div class="drive-item-thumb">
												<a href="#"><img class="img-responsive"
													src="assets/images/drive/drive-thumb-1.jpg" alt="" /></a>
											</div>
										</div>
										<div class="drive-item-footer module-footer">
											<ul class="utilities list-inline">
									...
									<div class="drive-item module text-center">
										<div class="drive-item-inner module-inner">
											<div class="drive-item-title">
												<a href="#">Image DS1341.JPG</a>
											</div>
											<div class="drive-item-thumb">
												<a href="#"><img class="img-responsive"
													src="assets/images/drive/drive-thumb-2.jpg" alt="" /></a>
											</div>
										</div>
										<div class="drive-item-footer module-footer">
											<ul class="utilities list-inline">
									...
									<div class="drive-item module text-center">
										<div class="drive-item-inner module-inner">
											<div class="drive-item-title">
												<a href="#">Image DS3214.JPG</a>
											</div>
											<div class="drive-item-thumb">
												<a href="#"><img class="img-responsive"
													src="assets/images/drive/drive-thumb-3.jpg" alt="" /></a>
											</div>
										</div>
										<div class="drive-item-footer module-footer">
											<ul class="utilities list-inline">
									...
									<div class="drive-item module text-center">
										<div class="drive-item-inner module-inner">
											<div class="drive-item-title">
												<a href="#">Sketch-source-files.zip</a>
											</div>
											<div class="drive-item-thumb">
									...
									<div class="drive-item module text-center">
										<div class="drive-item-inner module-inner">
											...
											<div class="drive-item-thumb">
												<a href="#"><img class="img-responsive"
													src="assets/images/drive/drive-thumb-4.jpg" alt="" /></a>
											</div>
										</div>
										<div class="drive-item-footer module-footer">
											<ul class="utilities list-inline">
