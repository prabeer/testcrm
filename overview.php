...
<?php if ($project_id != "" && is_numeric ( $project_id )) {
	$bug_cnt = 0;
	$tc_cnt = 0;
	$inv_cnt = 0;
	$mem_cnt =0;
	
	$query = "SELECT bug_count FROM weattach_CRM.project_wise_bug_count where project_id = :project_id;";
	$condition = [ 
											...
											<ul class="row list-unstyled">
												<li class="item item-1 col-lg-6 col-md-6 col-sm-6 col-xs-6">
													 <span aria-hidden="true"
														...
														class="data text-success"><?php echo $bug_cnt;?></span> <span class="desc">Bugs</span>
												
												</li>
												<li class="item item-3 col-lg-6 col-md-6 col-sm-6 col-xs-6">
													 <span aria-hidden="true"
														class="icon icon_easel text-purple"></span> <span
														class="data text-purple"><?php echo $tc_cnt;?></span> <span class="desc">Test
															Cases Pending</span>
												...
												<li class="item item-2 col-lg-6 col-md-6 col-sm-6 col-xs-6">
													 <span aria-hidden="true"
														...
														class="data text-info"><?php echo $inv_cnt;?></span> <span class="desc">Inventry</span>
												
												</li>
												<li class="item item-3 col-lg-6 col-md-6 col-sm-6 col-xs-6">
													<span aria-hidden="true"
														class="icon icon_group text-pink"></span> <span
														class="data text-pink"><?php echo $mem_cnt;?></span> <span class="desc">Members</span>
