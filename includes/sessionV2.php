...
/*
 * Create database, Table, Grant user with following
 * CREATE DATABASE `secure_sessions` ;
 *
 * CREATE USER 'sec_user'@'localhost' IDENTIFIED BY 'zG23gsdjh65hDfM';GRANT SELECT, INSERT, UPDATE, DELETE ON `secure_sessions`.* TO 'sec_user'@'localhost';
 *
...
class session {
	...
	private function encrypt($data, $key) {
		$salt = ')Aa%S9119@@F!#Vyby@ViUq#4Qj^5I_M*XmaH4knPXhzM2B8S9CO_7(X64M#9eiN';
